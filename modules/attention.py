...
class Attention():
    def __init__(self):
        pass
    def attention_net(self,enc, sl, dec, num_units, num_heads, num_blocks, dropout_rate, is_training, reuse):
        ...
        with tf.variable_scope("user_hist_group"):
          for i in range(num_blocks):
            with tf.variable_scope("num_blocks_{}".format(i)):
              ...
              # enc = tf.layers.dense(enc, num_units, activation=tf.nn.relu)
