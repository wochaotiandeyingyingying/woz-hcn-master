...
#把人说的话和电脑返回的索引形成一个元组返回,还返回对话段落的索引：dialog_indices。元组展示：[('good morning', 3), ("i'd like to book a table with italian food", 7), ('<SILENCE>', 13), ('in paris', 6), ('for six people please', 14), ('in a cheap price range please', 9),
